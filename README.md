...
This bridge is an attempt to help faclitate that backup, and help folks to overcome the onerous network effects that would otherwise make it difficult to get folks onto another protocol.  If you all find yourselves in a similar situation, we hope you'll find this to be useful : )
